...
function HeroContent() {
  return (
    <div className="text-left md:max-w-72 lg:max-w-lg">
      <p className="text-xl font-medium text-[#03a0c5]">Đặng Hữu Quang Huy</p>
      <h2 className="mt-4 font-serif text-3xl font-bold tracking-wide dark:text-white/80 md:text-4xl lg:mt-8 lg:text-5xl">
        Software Engineer...!
      </h2>
