...
const ServicesCard = ({ services }) => {
  return (
    <div
      className="flex flex-col gap-4 rounded-lg border-2 dark:border-white/10 dark:bg-white/5 bg-white/80 
    ...
    >
      <div className="flex justify-center">
        <services.icon
          ...
          p-3 text-5xl text-blue-500 dark:text-blue-300 transition-colors duration-200 
          hover:bg-blue-100 dark:hover:bg-blue-900 w-16 h-16"
        />
      </div>
